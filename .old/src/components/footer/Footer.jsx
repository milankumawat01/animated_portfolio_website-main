...
const Footer = () => {
  return (
    <div className=" mx-auto m-auto h-[300px]  mt-16 sm:h-[250px]">
      <div className=" bg-yellow-400 h-full flex flex-col gap-8 items-center justify-between p-10 sm:p-7">
        ...
        <div className=" flex items-center justify-center gap-8 sm:gap-5">
          ...
          <a
            ...
            href="https://api.whatsapp.com/send?phone=917340053710"
            className="box font-medium text-white  flex items-center justify-center flex-col"
          >
          ...
          <a
            ...
            href="https://www.instagram.com/milan.kumawat1/"
            className="box font-medium text-white  flex items-center justify-center flex-col"
          >
